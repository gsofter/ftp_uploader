...
CK_VISIBLE_PUBLIC BOOL CkFileAccessW_AppendBd(HCkFileAccessW cHandle, HCkBinDataW bd);
CK_VISIBLE_PUBLIC BOOL CkFileAccessW_AppendSb(HCkFileAccessW cHandle, HCkStringBuilderW sb, const wchar_t *charset);
