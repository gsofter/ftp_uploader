...
CK_VISIBLE_PUBLIC BOOL CkXml_getIsBase64(HCkXml cHandle);
...
CK_VISIBLE_PUBLIC BOOL CkXml_GetChildContentSb(HCkXml cHandle, const char *tagPath, HCkStringBuilder sb);
...
CK_VISIBLE_PUBLIC int CkXml_TagIndex(HCkXml cHandle, const char *tagPath);
